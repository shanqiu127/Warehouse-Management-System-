...
- 角色分工：employee 承接基础资料与进销业务入口，admin 聚焦系统治理与统计分析，superadmin 聚焦安全审计与系统治理
- 核心业务：进货、进货退货、销售、销售退货、库存预警
- 退货闭环能力：进货退货/销售退货均支持来源单关联与可退数量校验
- 单据处理机制：支持“仅作废”与“作废并红冲”双路径，业务更可控
- 作废审批流：employee 提交作废/红冲申请，admin 审批通过后执行作废动作
...
- 业务毛利看板：支持销售额、成本、毛利、毛利率总览，含品牌毛利 Top 与毛利日趋势
...
- `admin`：管理员，聚焦系统治理与销售毛利统计分析
- `employee`：普通员工，聚焦基础资料与进销业务操作
